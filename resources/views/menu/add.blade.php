...
<form action="{{route('menu.store')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="goods_name" class="form-control" id="tit" value="{{old('goods_name')}}"/>
    </div>

  {{--  <div class="form-group">
        <label for="ratin">评分</label>
        <input type="text" name="rating" class="form-control" id="ratin" value="{{old('rating')}}"/>
    </div>--}}
    ...
    <div class="form-group">
        ...
        <input type="text" name="goods_price" class="form-control" id="goods_pri" value="{{old('goods_price')}}"/>
    </div>
...
{{--
    ...
    <div class="form-group">
        ...
        <input type="text" name="tips" class="form-control" id="tip" value="{{old('rating_count')}}"/>
    </div>
{{--
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="satisfy_rate" class="form-control" id="satisfy_ra" value="{{old('satisfy_count')}}"/>
    </div>--}}
    ...
    <img id="pic" src="{{old('goods_img')}}" width="300px"/>
